...
from src.agent.reviewer.nodes.business_retriever import business_retriever
...
def build_graph():
    ...
    g.add_node("business_retriever", business_retriever)
    g.add_node("reasoner", reasoner)
    g.add_node("drafter", drafter)
    g.set_entry_point("analyst")
    g.add_edge("analyst", "retriever")
    g.add_edge("retriever", "business_retriever")
    g.add_edge("business_retriever", "reasoner")
